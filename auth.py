...
AUTH0_DOMAIN = os.environ.get('AUTH0_DOMAIN', 'dev-9a27t4db.us.auth0.com')
ALGORITHMS = os.environ.get('ALGORITHMS', '[\'RS256\']')
API_AUDIENCE = os.environ.get('API_AUDIENCE', 'actormovie')
...
def verify_decode_jwt(token):
    ...
    if rsa_key:
        ...
        except jwt.JWTClaimsError as ce:
            print("claims error ", ce)
            raise AuthError({
                'code': 'invalid_claims',
